...
import {toApiProjectType} from "../projects-list/projects-list.component";
    ...
    this.projectCards.push(
      {
        ...
        type: toApiProjectType(ProjectType[ProjectType.COLOC]),
        ...
        route: "../lcd/new",
        type: toApiProjectType(ProjectType[ProjectType.LCD]),
        ...
        route: "../idr/new",
        type: toApiProjectType(ProjectType[ProjectType.IDR]),
